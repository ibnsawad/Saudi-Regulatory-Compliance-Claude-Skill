...
| 07 | `test-07-telework.md` | Hybrid workforce + BYOD + contractor remote | TCC-1:2021, ECC-2:2024, DCC-1:2022, PDPL, NCS-1:2020 |
...
- OSMACC-1:2021 — no standalone social-media-account assessment test; embedded in 08. Reference file is compliance-grade in v4 (533 lines, all 38 subcontrols, per-subdomain evidence, 25 audit flags).
- CST CRF RT08 — no standalone ICT Service Provider test; embedded in 01 and 09.
- CGEC-1:2019 — no standalone consumer-protection / operator-obligations test; embedded in 08. Reference file is compliance-grade in v4 (502 lines, all 21 guidelines, operator-implication layer, mandatory-vs-advisory table).
- CGESP-1:2019 — no standalone e-commerce SME/SoHo operator test; embedded in 08. Reference file is compliance-grade in v4 (817 lines, all 34 guidelines, SoHo/SME scope markers, regulatory mapping per guideline).
- NCS-1:2020 — no standalone cryptographic-standards audit test. Reference file is compliance-grade in v4 (668 lines, all algorithms/key-sizes verbatim, MODERATE vs ADVANCED comparison table, protocol suites, KLM evidence, 23 audit flags).
