...
Confirm the skill applies **TCC-1:2023** as a discrete overlay rather than folding telework into general remote-access guidance.
...
- **NCA TCC-1:2023** primary for the assessment lens
...
|----|--------------------------|--------|----------|---------|----------|
| F-001 | TCC-1:2023 — MFA strength (TOTP for privileged remote) | Partial | High | Medium | P1 |
| F-002 | TCC-1:2023 — VPN split-tunnel for sensitive workloads | Partial | High | High | P1 |
| F-003 | TCC-1:2023 — Posture checks enforced (not just configured) | Non-compliant | High | High | P1 |
| F-004 | TCC-1:2023 — BYOD with MDM, separation of personal/work, EDR | Non-compliant | High | High | P1 |
| F-005 | TCC-1:2023 — Endpoint DLP for sensitive client data | Non-compliant | High | High | P1 |
| F-006 | TCC-1:2023 — Geo / anomaly alerting on remote logins | Non-compliant | Medium | Medium | P2 |
| F-007 | TCC-1:2023 — Contractor remote access (time-bound, posture, jump host) | Non-compliant | High | High | P1 |
| F-008 | TCC-1:2023 — Telework-specific awareness | Non-compliant | Medium | Low | P3 |
...
1. Surfaces TCC-1:2023 as a discrete overlay, not as "remote access controls".
